            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="flex items-center gap-2 group">
                            ...
                            <span className="text-xl font-black text-foreground tracking-tighter">VELORA<span className="text-primary">ESCORTWORLD</span></span>
                        </Link>
                    ...
                    {/* Support */}
                    <div>
                        <h4 className="text-foreground font-black text-xs uppercase tracking-[0.2em] mb-8 flex items-center gap-2">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={link.label}>
                                    <Link href={link.href} className="text-muted-foreground hover:text-primary font-bold text-xs uppercase tracking-widest transition-colors flex items-center gap-2 group">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-muted-foreground/60 uppercase tracking-widest mb-1">E-POSTA</p>
                                    <p className="text-sm font-black text-foreground">support@veloraescort.com</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary shrink-0">
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-muted-foreground/60 uppercase tracking-widest mb-1">TELEGRAM</p>
                                    <p className="text-sm font-black text-foreground">@veloraofficial</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-t border-border/50 py-12">
                    <div className="max-w-4xl">
                        <h5 className="text-[10px] font-black text-foreground uppercase tracking-[0.3em] mb-6 underline decoration-primary underline-offset-8 decoration-2">Premium Escort İlan Platformu</h5>
                        <p className="text-zinc-500 text-[11px] leading-loose font-medium italic mb-6">
                        ...
                        <div className="bg-destructive/5 border border-destructive/10 p-6 rounded-2xl">
                            <h6 className="text-[10px] font-black text-destructive uppercase tracking-[0.2em] mb-3 flex items-center gap-2">
