...
export function HeroSearch({ cities }: { cities: { id: string; name: string; slug: string }[] }) {
    ...
    return (
        <div className="w-full max-w-full sm:max-w-xl mx-auto relative group" ref={wrapperRef}>
            <div className={`
            ...
            `}>
                ...
                <input
                    ...
                    className="flex-1 h-10 sm:h-12 bg-transparent border-none outline-none text-gray-800 font-bold text-base sm:text-lg placeholder:text-gray-400 placeholder:font-medium"
                />
                ...
                <button
                    className="bg-primary hover:opacity-90 text-white rounded-full px-4 sm:px-8 h-10 sm:h-12 flex items-center gap-2 transition-all font-black text-sm uppercase tracking-wider shadow-lg shadow-primary/30 active:scale-95"
                >
