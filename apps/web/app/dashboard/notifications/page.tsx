    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tighter">Bildirimler</h1>
                    <p className="text-gray-500 font-medium">Hesabınızla ilgili anlık gelişmeleri takip edin.</p>
                </div>
                ...
                <CardContent className="p-0">
                    <div className="divide-y divide-gray-50">
                        {notifications.map((n) => (
                            <div
                                key={n.id}
                                className={`p-6 flex items-start justify-between hover:bg-gray-50 transition-colors ${!n.is_read ? 'bg-primary/5' : ''}`}
                            >
                                <div className="flex gap-4">
                                    <div className="mt-1 p-3 rounded-xl bg-white shadow-sm shrink-0">
                                        {getIcon(n.type)}
                                    </div>
                                    <div className="space-y-1">
                                        <div className="flex items-center gap-2">
                                            <h3 className="font-black text-gray-900 uppercase tracking-tighter text-sm">{n.title}</h3>
