        ...
        <div className="container mx-auto px-4 py-8 animate-in fade-in duration-500">
            <div className="mb-8">
                <h1 className="text-3xl font-black text-white tracking-tight flex items-center gap-3 uppercase">
                    <Crown className="h-8 w-8 text-primary shadow-glow" /> Premium Profiller
                </h1>
                <p className="text-gray-500 mt-1 font-bold uppercase text-xs tracking-widest">
                    Toplam <span className="text-primary font-black">{listings.length}</span> premium profil yayında
                </p>
            </div>
